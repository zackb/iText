...
@implementation ZBNoteCanvas

+ (NSString *) urlForNote: (ZBNote *) note
{
    NSString *path = [NSTemporaryDirectory() stringByAppendingPathComponent: @"note.html"];
    
    NSString *html = [note text];
